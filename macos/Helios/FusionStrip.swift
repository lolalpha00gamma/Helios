...
struct FusionStrip: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            if let fusion {
                Text(String(format: "führt %@  ·  Pose %.0f %%  ·  Pinzette %.0f %%  ·  H %.2f  ·  Tor %.0f %%", fusion.source, fusion.poseProb * 100, fusion.pinchClosedness * 100, fusion.entropy, GestureMath.entropyActionFloor(entropy: fusion.entropy) * 100))
